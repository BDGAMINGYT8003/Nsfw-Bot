...
module.exports = {
    ...
    async run(bot, message, args) {
        ...
        try {
            const response = await axios.get('https://nekobot.xyz/api/image?type=blowjob', { timeout: 10000, headers: { 'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36' } });
            const embed = new EmbedBuilder()
            ...
            console.error(chalk.red('[COMMAND ERROR] ▸ Error in blowjob command:'));
